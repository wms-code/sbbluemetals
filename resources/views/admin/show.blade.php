...
<div class="container">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    {{ ucfirst(config('admin.prefix')) }} List
                    <span class="float-right">
                        <a href="{{route('admin.register')}}" class="btn btn-sm btn-success">New {{ ucfirst(config('admin.prefix')) }}</a>
                    </span>
                </div>
                <div class="card-body">
    @include('admin.message')
                    <ul class="list-group">
                        ...
                        <p>No {{ config('admin.prefix') }} created Yet, only super {{ config('admin.prefix') }} is available.</p>
                        @endif
                    </ul>
                </div>
            </div>
