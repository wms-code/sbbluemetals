...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>B</b>GV</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Body</b>Glove.info</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <li>
                ...
                <ul class="menu">
                  ...
                  @admin('super')
                  <li><a class="dropdown-item" href="{{ route('admin.show') }}">{{ ucfirst(config('admin.prefix')) }}</a></li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="https://pngimage.net/wp-content/uploads/2018/06/gambar-user-png-2.png" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ url('admin/color')}}"><i class="fa fa-circle-o"></i> Colour</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2022 <a href="http://example.com">Company Name</a>.</strong> All rights
    reserved.
  </footer>
