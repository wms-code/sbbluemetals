...
<head>
    ...
    <!-- Favicon icon --> 
    <link href="{{ url('invoice1/css/jquery-ui.min.css') }}" rel="stylesheet">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('assets')}}/images/favicon.png">
    <title>@yield('pagetitle',"Home")</title>    
    <link href="{{ url('assets/plugins/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    
    <link href="{{ url('invoice1/css/style.css') }}" rel="stylesheet">
     
    <script src="{{ url('invoice1/js/lib/jquery-3.3.1.min.js')}}"></script>
    <script src="{{ url('invoice1/js/lib/jquery-ui.min.js')}}"></script>
