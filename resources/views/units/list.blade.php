                        ...
                        <div class="card">
                            <div class="card-block">
                                    <div class="row justify-content-between">
                                            ...
                                            <div class="col-6">
                                                    <div class="float-right"><a class="btn btn-sm  btn-primary" href="{{ url('admin/unit/create') }}">Add New</a></div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="{{ url('admin/unit') }}/{{$d->id}}/edit" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
